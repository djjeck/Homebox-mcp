...
10. **create_item** - Add a new item to the inventory
11. **update_item** - Update an existing item (name, description, location, tags, purchase info, warranty, etc.)
12. **delete_item** - Permanently delete an item
13. **create_location** - Add a new storage location
14. **delete_location** - Delete a location
15. **create_tag** - Add a new tag/category
16. **delete_tag** - Delete a tag
17. **create_maintenance_entry** - Record a maintenance event on an item
18. **delete_maintenance_entry** - Delete a maintenance entry
